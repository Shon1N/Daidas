;(function($, window, document, undefined){
    ...
    var AuxinAjaxAddToCart = function() {
        ...
        $(document).on( 'click', '.aux-ajax-add-to-cart', function(e) {
            ...
            var action = "auxels_add_to_cart";

            $.ajax("https://masfitness.co.za?"
            +"action=auxels_add_to_cart" 
            +"&args=auxin_cart_options"
            +"&product_id=" +product_id
            +"&quantity=" + 1,
            +"&verify_nonce="+ verify_nonce,
            location.href = "https://masfitness.co.za/product/" + product_id
           // +"action=ql_woocommerce_ajax_add_to_cart" 
            ...
            //     if(auxin && auxin.ajax_url)
            //     console.log("auxi url", auxin.ajax_url)
            // $.ajax({
            //     type: 'POST',
            //     dataType: 'json',
            //     //url: "https://masfitness.co.za/product",//auxin.ajax_url,
            //     // data: {
            //     //     action      : "auxels_add_to_cart",
            //     //     args        : auxin_cart_options,
            //     //     product_id  : product_id,
